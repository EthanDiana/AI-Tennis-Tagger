...
def video_process(video_path, show_video=False, include_video=True,
    ...
    print('Finished Video Properties')
    ...
    while True:
        print('Looping through video frames...')
...
def main():
    s = time.time()
    video_process(video_path='AhmaniTexasFirstCoupleSec.mp4', show_video=True, stickman=True, stickman_box=True, smoothing=True,
